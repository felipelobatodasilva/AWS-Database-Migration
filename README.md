...
Once you've already accessed the root user, type on the terminal the following command "yum install -y https://download.postgresql.org/pub/repos/yum/11/redhat/rhel-6-x86_64/postgresql11-libs-11.13-1PGDG.rhel6.x86_64.rpm which is the same version we installed for RDS.
